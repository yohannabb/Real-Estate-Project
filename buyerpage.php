      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul>
            ...
            <li><a href="buyerchangepass.php" >ChangePassword</a></li>
            <!-- <li><a href="#">HELP</a></li> -->
          </ul>
...
<div class="row mt-4">
   <?php
 $result1=mysqli_query($conn,"SELECT * FROM `house` where status='for sell'&&sold_status=0");
  ...
  while($row=mysqli_fetch_array( $result1)){
    ...
    <!-- <form method="post" action="https://test.yenepay.com/">
                ...
                <button type="submit" class="btn btn-primary">ViewDetail</button> 
                 ...
                 <form action="payProcess.php" method="get">
<button type="submit" name='buy'
 value="<?php echo $row['id'];?>" class="btn btn-primary"alignment:left> Buy</button> 
    </form >

    <form action="buydetail.php?id=<?php echo $row['id'];?>" method ="post">
