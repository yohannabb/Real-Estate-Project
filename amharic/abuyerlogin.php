...
<body>
	...
	<div class='login'>
	 ...
	 <img src="img/icon.png" alt="" class='login-form'>
		 ...
		 <a href="abuyer.php" class='btn btn-primary'>መለያ ፍጠር</a>
         <a href="./../buyerchangepass.php" class='btn btn-primary'>የሚስጥር ቁልፍ ይቀይሩ</a>
		 <h1>h</h1>
     </form>
	 </div>
	 </center>
...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
 ...
 $sql = "SELECT * FROM buyer WHERE username='$username' AND pasword ='$password'";
