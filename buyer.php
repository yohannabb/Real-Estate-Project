            ...
            <div class="aa-signin-form">
              ...
              <form class="contactform" action="" method="post">                                                
                <div class="aa-single-field">
                  <label for="name">firstname <span class="required">*</span></label>
                ...
                <div class="aa-single-field">
                  <label for="name">lastName <span class="required">*</span></label>
                ...
                <div class="aa-single-field">
                <label for="name">Sex <span class="required">*</span></label><br/>
                <input type="radio" id="sex" name="Sex" value="female" />Female
                <input type="radio" id="sex" name="Sex" value="male" />Male<br/><br/>
                <div class="aa-single-field">
                ...
                <div class="aa-single-submit">
                  ...
                  Already a member? <a href="buyerlogin.php" class='btn btn-primary'>LOGIN</a>        
                </div>
              </form>
            </div>
          </div>
