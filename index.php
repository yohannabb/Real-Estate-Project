            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-right">
                  <!-- <a href="#" class="aa-login">English</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
                  <a href="amharic/aindex.php" class="aa-login">Amharic</a>&nbsp;&nbsp;&nbsp;
                  <a href="admin/login.php" class="aa-login">ADMIN</a>
                </div>
              </div>              
            </div>
          </div>
            ...
            <li class="active"><a href="index.php">HOME</a></li>
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">                
                <li><a href="buyerlogin.php">Buy</a></li>
                <li><a href="renterlogin.php">Rent</a></li>                                            
              </ul>
            </li>
...
<div class="row mt-4">
 ...
 if( $check){
  while($row=mysqli_fetch_array( $result1)){
    ...
    <a href='buyer.php'> <input type="submit" name='buy'
 value='BUY NOW!' class="btn btn-primary"alignment:left></a>
 <a href=''> <input type="submit" name='view'
 value='View Detail!' class="btn btn-primary"alignment:left></a>
 </div>
 </div>
 </div>
    <?php
...
<div class="row mt-4">
 ...
 if( $check){
  while($row=mysqli_fetch_array( $result1)){
    ...
    <h5 class="card-title">Price:<?php echo $row['price'];?></h5>
    <h5 class="card-title">Address:<?php echo $row['address'];?></h5>
    <a href='renter.php'> <input type="submit" name='rent'
 value='RENT NOW!' class="btn btn-primary"alignment:left></a>
 <a href=''> <input type="submit" name='view'
 value='View Detail!' class="btn btn-primary"alignment:left></a>
 </div>
 </div>
 ...
 if( $check){
  while($row=mysqli_fetch_array( $result1)){
    ...
    <img src="<?php echo $row['image'];?>" class="card-img-top"  alt="" width='250px' hight='350px'>
     <div class="card-body">
    <h3 class="card-title">Name:<?php echo $row['name'];?></h3>
    <h4 class="card-title">Email:<?php echo $row['email'];?></h4>
    <h5 class="card-title">Phone:<?php echo $row['phonenumber'];?></h5>
    <a href='#'> <input type="submit" name='contact me'
 value='contact me' class="btn btn-primary"alignment:left></a>
 </div>
 </div>
 </div>
        ...
        <div class="aa-footer-area">
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <p>&copy;Designed by <a rel="nofollow" href="index.php">BDU Students</a></p>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
