            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6">
                <div class="aa-header-right">
                  <a href="signin.html" class="aa-login">ግባ</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li class="active"><a href="aindex.php" >ዋና ገፅ</a></li>
            <li class="active"><a href="agallery.php">ማዕከለ-ስዕላት</a></li>                                         
            
            <li class="active"><a href="acontact.php">እውቂያ</a></li>
        ...
        <div class="col-md-12">
          <div class="aa-gallery-area">
            <div class="aa-title">
              <h2>የጋለሪ እይታ</h2>
              <span></span>
               <p>ጣና ሪል እስቴት ላይ የሚገኙ አንዳንድ ቤቶች </p>
            </div>
            <!-- Start gallery -->
            <div class="aa-gallery-content">
              <div class="aa-gallery-top">
                <!-- Start gallery menu -->
                <ul>
                  <li data-filter="all" class="filter active">ሁሉም</li>
                  <li data-filter=".apartment" class="filter">አፓርትመንት</li>
                  <li data-filter=".livingroom" class="filter">ሳሎን</li>
                  <li data-filter=".bedroom" class="filter">መኝታ ቤት</li>
                  <li data-filter=".kitchen" class="filter">ወጥ ቤት</li>
                  <li data-filter=".garage" class="filter">ጋራዥ</li>
                </ul>
              </div>
              <!-- Start gallery image -->
        ...
        <div class="aa-footer-area">
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <p>የተነደፈ በ <a rel="nofollow" href="#">BDU ተማሪዎች</a></p>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
