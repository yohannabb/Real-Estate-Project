      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul>
            ...
            <li><a href="renterpasschange.php">CHANGE PASSWORD</a></li>
            <!-- <li><a href="#">HELP</a></li> -->
          </ul>
...
if(isset($_POST['search']))
    {
$search = $_POST['id'];
  $query = "SELECT * FROM house WHERE (status='for rent') AND (image= '$search' || type='$search' || price='$search' || address='$search') ";
...
while($row=mysqli_fetch_array($query_run))
{
  ...
  <h4 class="card-title">Address:<?php echo $row['address'];?></h4>
</div>
</div>
</div>
  ...
  echo '<script>alert("NO HOUSE FOUND!!")</script>';
}
 }
?>
</div>
...
<div class="row mt-4">
   <?php
 $result1=mysqli_query($conn,"SELECT * FROM `house` where status='for rent'&&sold_status=0");
 ...
 if( $check){
  while($row=mysqli_fetch_array( $result1)){
    ...
    <!-- <form method="post" action="https://test.yenepay.com/">
                  ...
                  <input type="hidden" name="successUrl" value="http://localhost/final/Reales/Reales/sucess2.php">
                  
                  <input type="hidden" name="cancelUrl" value="http://localhost/final/Reales/Reales/buyerpage.php">
                  ...
                  <input type="hidden" name="unitPrice" value="20">
                ...
                <button type="submit" class="btn btn-primary">ViewDetail</button> 
                 ...
                 <form action="payProcess2.php" method="get">
<button type="submit" name='rent'
 value="<?php echo $row['id'];?>" class="btn btn-primary"alignment:left> Rent</button> 
    </form >

    <form action="rentdetail.php?id=<?php echo $row['id'];?>" method ="post">
        ...
        <div class="aa-footer-area">
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
              ...
              <p>&copy;Designed by <a rel="nofollow" href="#">BDU Students</a></p>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
