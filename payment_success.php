...
$sql="update  payment set payed_amount='$TotalAmount', paymentstatus='$statusww' where id=$MerchantOrderId ";
$sql2="update  house set sold_status=1 where id=$houseid ";
$sql3="update  payment set paymentstatus='$statusww' where id=$MerchantOrderId";
