            ...
            <li class="active"><a href="index.php">HOME</a></li>
             <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">                
                <li><a href="services.html">Buy</a></li>
                <li><a href="rent.html">Rent</a></li>                                            
              </ul>
            </li>
            <li><a href="gallery.php">GALLERY</a></li>                                         
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="blog-archive.html">REGISTER <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">                
                <li><a href="As_buyer.php">Register AS Buyer</a></li>
                <li><a href="As_renter.php">Regester As Renter</a></li>                                            
              </ul>
            </li>
