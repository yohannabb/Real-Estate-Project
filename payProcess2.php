...
$successUrl = "http://localhost/final/Reales/Reales/payment_success2.php";
$cancelUrl = "http://localhost/final/Reales/Reales/payment_success2.php";
$failureUrl = "http://localhost/final/Reales/Reales/payment_success2.php";
...
$houseidd=$_GET['rent'];
$lastId=1;
$result2=mysqli_query($conn,"SELECT * FROM `payment_renter` order By id");
...
$result1=mysqli_query($conn,"SELECT * FROM `house` where id='$houseidd'&& status='for rent'");
...
$checkoutOrderItem  -> ItemId =$houseidd;
...
$_SESSION['houseid']=$houseidd;
$sql2="insert into payment_renter(payer_name,phonenumber,house_id) values('$firstname','$phone','$houseidd')";
